...
This dataset is derived from the "Human Activity Recognition Using Smartphones Data Set" and can be found here: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
...
The set of variables that were kept for this assignment from these signals are: 
